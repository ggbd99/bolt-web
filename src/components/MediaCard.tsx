    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 w-[150px] sm:w-[180px] md:w-[200px] flex-shrink-0">
          <div className="relative aspect-[2/3] overflow-hidden rounded-lg bg-zinc-900 shadow-xl group-hover:shadow-2xl group-hover:shadow-cyan-500/30 transition-all duration-300 border border-zinc-800 group-hover:border-cyan-500/50">
            ...
            {/* Media Type Badge - Bottom for Top 10 */}
